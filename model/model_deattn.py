...
def build_model(emb_matrix,maxlen,projection_dim=300, 
                ...
                dense_dim=300, dense_dropout=0.5,
    ...
    #merge = Concatenate()([seq1_rep, seq2_rep,feat_input])
...
for curr_fold, (idx_train, idx_val) in enumerate(folds):
    ...
    bst_model_path = 'deattn_fold{}.h5'.format(curr_fold)
...
with open('./input/probs_deattn.train', 'w') as fout:
